                        ...
                        <tbody>
                            @foreach ($blogs as $index => $blog)                            
                                ...
                                <tr>
                                    <td>{{$index+1}}</td>
                                    <td>
                                        <a href="{{route('articles.edit', [$blog->id])}}" style="color:#00838f;" class="underline">
                                    ...
                                    <td>
                                        <a href="{{route('articles.edit', [$blog->id])}}" class="bnt btn-sm btn-warning text-light" title="Edit"><i class="fa fa-pencil"></i></a>
                                        <form class="d-inline" method="POST" action="{{route('articles.destroy', [$blog->id])}}" >
                                            @method('delete')
                                            @csrf   
