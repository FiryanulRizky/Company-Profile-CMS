...
Route::get('/blog/{slug}', 'BlogController@show_article')->name('blog.show');
Route::post('/articles/upload', 'BlogController@upload')->name('articles.upload')->middleware('auth');
Route::resource('/articles', 'BlogController')->middleware('auth');
